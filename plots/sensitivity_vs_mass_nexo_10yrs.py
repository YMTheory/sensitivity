...
nexo_10yrs = 9.5e27 ## half-life limit in 5 yrs evaluated with Ba-tag for McKeown/2015 (yr)
...
#ax1.text( xlim[0]*1.15, 0.95*np.mean([lmax_notag, lmax_10yrs]), r"nEXO 10 Years", ha="left", va="center", fontsize=12)

plt.savefig("sens_nexo"+suffix+"_5yrs.pdf")
