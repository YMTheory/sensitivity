...
class ExcelTableReader:
    ...
    def __init__(self):
        self.filename = '../tables/Summary_v68_2016-06-21_0nu.xlsx' #'../tables/Summary_v62_2016-06-04_0nu_tpc_elec.xlsx'
        ...
        self.hiteff_sheet = {'name': 'MC_RawCounts_%s_Integrals', 'startRow': 6, 'componentColumn': 'A', 'isotopeColumn': 'B', 'nColumn': 'C', 'kColumn': 'AH', '1tColumn': 'F', '3tColumn': 'N', 'fvColumn': 'R'}
    ...
    def ReadHitEfficiency(self,suffix):
        ...
        for row in range(start_row,end_row):
            ...
            if hiteff[pdf]['k'] == 0:
                ...
                hiteff[pdf]['1t'] = self.GetCellValue(ws,sheet['1tColumn'],row)*1./hiteff[pdf]['k']
...
class RootTreeWriter():
    ...
    def __init__(self):
        self.filename = '../tables/Summary_v68_2016-06-21_0nu.root' #'../tables/Summary_v62_2016-06-04_0nu_tpc_elec.root' #'test_new_tree.root'

        self.pdf_filename_pattern = '/data/data033/exo/software/nEXO_Sensitivity/quick/v5/histos/individual_histos/nEXO_Histos_%s.root'
