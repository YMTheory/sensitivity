...
resultsFileName = 'fits_db_v73_2016-09-26_bb2n_0nu_rdm_%0.1f_years_0.0_counts_*.root' #fits_db_v73_2016-09-09_0nu_scale1_not2nu_allbkgs_rdm_%0.1f_years_0.0_counts_*.root' #'fits_hamamatsu_v68_2016-06-21_0nu_eff_fine_rdm_%0.1f_years_0.0_counts_*.root' #'fits_db_v73_2016-09-09_0nu_rdm_%0.1f_years_0.0_counts_*.root' # 'fits_hamamatsu_v68_2016-06-21_0nu_ssfrac20_fine_rdm_%0.1f_years_0.0_counts_*.root' # 'fits_hamamatsu_0nu_eff_tpc_klzfix_%0.1f_years_0.0_counts_*.root'

ROOT.gSystem.Load('../lib/libnEXOSensitivity.so')

#nu = ROOT.nEXOUtil()

all_years = [10.0] #[0.5,1.0,2.5,5.0,10.] #[5.0] #[0.5,1.0,2.5,5.0,10.] #[0.5,1.0,2.5,5.0,10.] #[1.4,2.9,4.2,8.7] #[0.5,1.0,2.5,5.0,10.,12.5,15.0,20.0] #[5.0] #[0.5,1.0,2.5,5.0,10.]
graph = ROOT.TGraph()
graph2 = ROOT.TGraph()
invgr = ROOT.TGraph()
gr1t = ROOT.TGraph()
