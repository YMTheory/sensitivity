...
input_table_label = input_name.split('_')[-1] if 'gaus' in input_name.split('_')[-1] \
                                             else '{}_{}'.format(input_name.split('_')[-2],\
...
output_df.to_hdf('{}/sens_output_lowEresolution_study_90CL_{}_{:03}.h5'.format(output_dir,input_table_label,iteration_num),key='df')
