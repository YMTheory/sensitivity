...
outputname = ""
executable_name = 'Compute90PercentLimit_WilksApprox_CaioLowEnergyRes.py'
tables_dir = '/g/g20/lenardo1/nEXO/sensitivity/tables/LowEResolutionStudy/' 
...
#	continue
		...
		thescript = "#!/bin/bash\n" + \
			...
			"python3 SensitivityPaper2020_scripts/CaioLowEnergyResolutionStudy/" + executable_name +\
	                                                " {} {} {} {} {} \n".format(\
