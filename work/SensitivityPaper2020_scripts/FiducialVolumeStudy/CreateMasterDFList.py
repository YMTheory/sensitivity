...
critical_lambda_dir = '/p/lustre2/lenardo1/sensitivity_output/Apr14_SensitivityVsFiducialVolumeCriticalLambda_D024/'
scale_factor_tag = '_2500_'
num_iterations = 10
...
with open(critical_lambda_dir + 'master_df_list_fidvol{}D-024.pkl'.format(scale_factor_tag),'wb') as pklfile:
