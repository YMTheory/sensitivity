...
for lt_years in [0.5, 1, 2, 5, 10]:
    ...
    workspace = nEXOFitWorkspace.nEXOFitWorkspace(
        '../config/Sensitivity2020_Optimized_DNN_Standoff_Binning_version1.yaml')
    ...
    workspace.CreateComponentsTableFromMaterialsDB('D-024',
                                                   histograms_file='../component_tables/D-024_Baseline2019_Histograms_05.h5')
    print(workspace.df_components.head())

    # workspace.LoadComponentsTableFromFile('../component_tables/ComponentsTable_D-023_merged-v5_final_cuts.h5')
    ...
    ss_cut_dict = {'DNN': (0.8, 1), 'Energy (keV)': (700., 3500.), 'Standoff (mm)': (0., 650.)}
    ms_cut_dict = {'DNN': (0., 0.8), 'Energy (keV)': (700., 3500.), 'Standoff (mm)': (0., 650.)}
