...
lt_years = 10
for resolution in ['0.009', '0.01', '0.011', '0.012', '0.013', '0.014', '0.015', '0.016']:
	...
	output_df.to_hdf('{}/h5/{}/sens_output_file_90CL_{}_livetime_years_{}_00.h5'.format(output_dir,date,
																								iteration_num,lt_years),
					 key='df')
