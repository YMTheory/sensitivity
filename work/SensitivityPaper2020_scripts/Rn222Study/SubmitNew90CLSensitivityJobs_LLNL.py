...
outputdir = "/p/lustre2/lenardo1/sensitivity_output/Mar1_Rn222Study_merged-v11_OptimizedV1Binning_D023/"
outputname = "Jan19_Rn222Study_merged-v11_OptimizedV1Binning"
...
components_table = '/p/vast1/nexo/sensitivity2020/pdfs/component_tables/'+\
                       'ComponentsTable_D-023_merged-v11_Optimized_DNN_Standoff_Binning_version1.h5'
...
rn222_scale_factors = [1.,0.01,0.1,0.3,3.,10.,100.]
...
for rn222_scale_factor in rn222_scale_factors:
	print('\n\nSubmitting jobs with x{:4.4} Rn222 scaling.\n\n'.format(rn222_scale_factor))
