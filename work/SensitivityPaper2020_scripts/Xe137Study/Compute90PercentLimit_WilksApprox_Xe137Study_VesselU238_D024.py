...
vesselu238_scale_factor = float(sys.argv[6])
...
output_df.to_hdf('{}/sens_output_file_xe137study_vesselu238_{:0>4.4}x_90CL_{:03}_D024.h5'.format(\
                         output_dir, vesselu238_scale_factor, job_id_num ),\
                         key='df')
