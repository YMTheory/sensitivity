...
if len(sys.argv) == 7:
	...
	print('\tpython ComputeCriticalLambdaForNumSignal.py ' + \
		...
		'<input_components_table> <xe137_scale_factor>')
	sys.exit('\n')
######################################################################
...
output_df.to_hdf('{}/critical_lambda_calculation_xe137study_{:0>4.4}x_D-024_num_sig_{:06.6}_file_{}.h5'.format(\
			output_dir, xe137_scale_factor, input_num_signal, iteration_num),key='df')
