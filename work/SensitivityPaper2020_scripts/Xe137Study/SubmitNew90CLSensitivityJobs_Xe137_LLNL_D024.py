...
outputname = ""
executable_name = 'Compute90PercentLimit_WilksApprox_Xe137Study_D024.py'
...
for xe137_scale_factor in xe137_scale_factors:
	print('\n\nSubmitting jobs with x{:4.4} Xe137 scaling.\n\n'.format(xe137_scale_factor))
