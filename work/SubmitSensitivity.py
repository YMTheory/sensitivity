...
all_years = [5.0] #[0.5,1.0,2.5,10.]#[5.0] #[0.5,1.0,2.5,10.]# [1.4,2.9,8.7] #[0.5,1.0,2.5,5.0,10.,12.5,15.0,20.0]
...
outDir = '../results'
outName = 'fits_hamamatsu_v68_2016-06-21_0nu_ssfrac20_fine_rdm' #'fits_hamamatsu_v61_2016-02-24_Si_Cu_0nu_tpc_cryo_elec_fine_rdm' #  'fits_hamamatsu_v68_2016-06-21_0nu_red8x_fine_rdm' # %(ssFracImprovement) 
treeFileName = '../tables/Summary_v68_2016-06-21_0nu.root' #'../tables/Summary_v61_2016-02-24_Si_Cu_0nu_tpc_cryo_elec.root' # '../tables/Summary_v68_2016-06-21_0nu_red8x.root' #'../tables/Summary_v62_2016-06-04_0nu_tpc_elec.root' #'../tables/Summary_v61_2016-02-24_Si_Cu_0nu_tpc_resol0.010.root'
jobDir = '../cluster/jobs/'
